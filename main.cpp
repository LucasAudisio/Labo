...
enemigoClase checkearEnemigos(vector<enemigoClase> TodoslosEnemigos, int xjugador, int yjugador){
    int xd = 0;
...
int main()
{
    ...
    vector<itemClase> items = {
        {"vacio.png", 0, 0, 0, 0},
        {"espadaFundida.png", 34, 34, 0.5, 0.1},
        {"espadaMadera.png", 32, 32, 0.5, 0},
        {"espadaHierro.png", 32, 32, 0.5, 0.1},
        {"armaduraNinja.png", 30, 18, 0.5, 2},
        {"armaduraHierro.png", 30, 19, 1, 2},
        {"armaduraFundida.png", 26, 18, 1.5, 2},
        {"arcoMadera.png", 16, 32, 3, 0},
        {"arcoHierro.png", 16, 32, 3, 0},
        {"arcoFundido.png", 18, 36, 3, -0.5},
    };
    ...
    while (window.isOpen())
    {
        ...
        enemigoClase enemigoEncontrado = checkearEnemigos(mapa.enemigos, Player.x, Player.y);
